...
abstract class SUMO_Abstract_Subscription_Settings {
    ...
    public function output_sections() {
        ...
        foreach ( $this->sections as $id => $label ) {
            echo '<li><a href="' . admin_url( 'admin.php?page=sumosettings&tab=' . $this->id . '&section=' . sanitize_title( $id ) ) . '" class="' . ( $current_section == $id ? 'current' : '' ) . '">' . $label . '</a> ' . ( end( $array_keys ) == $id ? '' : '|' ) . ' </li>' ;
        }
