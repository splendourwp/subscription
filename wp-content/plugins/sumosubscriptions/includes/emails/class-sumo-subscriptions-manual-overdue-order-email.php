...
class SUMOSubscriptions_Manual_Overdue_Order_Email extends SUMO_Abstract_Subscription_Email {
    ...
    function __construct() {
        ...
        $this->description    = addslashes( sprintf( __( 'Subscription overdue order %s emails are sent to the customer and the amount for the subscription renewal has not been paid within the overdue period.' , 'sumosubscriptions' ) , '--' ) ) ;
