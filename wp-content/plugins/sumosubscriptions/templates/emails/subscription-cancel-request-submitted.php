...
<p><?php printf( __( 'Your request to cancel your subscription #%s has been submitted successfully. <br><strong>Cancel Method: </strong> %s(%s). <br>' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) , $requested_cancel_method , $cancel_scheduled_on ) ; ?></p>
