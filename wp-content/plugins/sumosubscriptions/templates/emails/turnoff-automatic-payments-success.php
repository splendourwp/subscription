...
<p><?php printf( __( 'Automatic charging for your Subscription #%s has been turned off. <br>You will get a subscription payment reminder email using which you can pay for your subscription renewal.' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) ) ; ?></p>
