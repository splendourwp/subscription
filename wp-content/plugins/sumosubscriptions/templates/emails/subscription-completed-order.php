...
<p><?php printf( __( 'Hi,<br> Your recent Subscription order on %s has been Completed. Your order details are shown below for your reference' , 'sumosubscriptions' ) , get_option( 'blogname' ) ) ; ?></p>
...
<h2>
    ...
    if ( sumosubs_is_parent_order( $order ) && doing_action( 'woocommerce_order_status_changed' ) ) {
        ...
        printf( __( 'Subscription #%s' , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) ) ;
    }
    ?>
</h2>
