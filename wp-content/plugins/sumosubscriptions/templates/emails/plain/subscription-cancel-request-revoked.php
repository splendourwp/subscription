...
echo sprintf( __( "Your request to revoke the subscription cancellation of #%s has been proccessed successfully." , 'sumosubscriptions' ) , sumo_get_subscription_number( $post_id ) ) . "\n\n" ;
