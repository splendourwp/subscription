...
<li <?php post_class(); ?>>
	<div class="pp-woo-product-wrapper">
		...
		if ( 'yes' === $settings['show_add_cart'] ) {
			...
			echo '<a href=' . $product->add_to_cart_url() . ' class="pp-action-item-wrap pp-cart-section ' . $cart_class . ' product_type_' . $product->get_type() . '" data-quantity="1" data-product_id="' . $post_id . '">';
